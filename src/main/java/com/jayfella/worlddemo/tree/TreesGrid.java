...
public class TreesGrid extends ModelGrid {
    ...
    public Object[] buildCell(GridPos2i gridPos) {
        ...
        for (int i = 0; i < trees.length; i++) {
            ...
            int amount = (int) ((noiseEvaluator.evaluate(new Vector2f(gridPos.getWorldTranslationX(), gridPos.getWorldTranslationZ())) * (model.getMaxAmount() - model.getMinAmount())) + model.getMinAmount());
